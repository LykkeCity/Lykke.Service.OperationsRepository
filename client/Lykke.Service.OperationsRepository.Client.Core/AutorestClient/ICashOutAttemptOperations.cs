...
namespace Lykke.Service.OperationsRepository.AutorestClient
{
    ...
    public partial interface ICashOutAttemptOperations
    {
        ...
        /// </exception>
        Task<HttpOperationResponse<object>> InsertRequestWithHttpMessagesAsync(CashOutAttemptInsertRequest request = default(CashOutAttemptInsertRequest), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <param name='customHeaders'>
        /// The headers that will be added to request.
        /// </param>
        /// <param name='cancellationToken'>
        ...
        /// Thrown when unable to deserialize the response
        /// </exception>
        Task<HttpOperationResponse<object>> GetHistoryRecordsWithHttpMessagesAsync(System.DateTime fromParameter, System.DateTime to, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <param name='clientId'>
        /// </param>
        /// <param name='customHeaders'>
        /// The headers that will be added to request.
