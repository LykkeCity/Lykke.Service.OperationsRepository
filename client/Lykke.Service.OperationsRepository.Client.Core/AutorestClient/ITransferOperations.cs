...
namespace Lykke.Service.OperationsRepository.AutorestClient
{
    ...
    public partial interface ITransferOperations
    {
        ...
        /// Thrown when unable to deserialize the response
        /// </exception>
        Task<HttpOperationResponse<ErrorResponse>> SetIsSettledIfExistsWithHttpMessagesAsync(bool offchain, string clientId = default(string), string id = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <param name='blockchainHash'>
        /// </param>
        /// <param name='customHeaders'>
        /// The headers that will be added to request.
