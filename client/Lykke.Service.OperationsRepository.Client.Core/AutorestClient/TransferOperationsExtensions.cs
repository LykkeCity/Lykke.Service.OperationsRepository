...
namespace Lykke.Service.OperationsRepository.AutorestClient
{
    ...
    public static partial class TransferOperationsExtensions
    {
            ...
            /// <param name='id'>
            /// </param>
            public static ErrorResponse SetIsSettledIfExists(this ITransferOperations operations, bool offchain, string clientId = default(string), string id = default(string))
            {
                return operations.SetIsSettledIfExistsAsync(offchain, clientId, id).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ErrorResponse> SetIsSettledIfExistsAsync(this ITransferOperations operations, bool offchain, string clientId = default(string), string id = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.SetIsSettledIfExistsWithHttpMessagesAsync(offchain, clientId, id, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
