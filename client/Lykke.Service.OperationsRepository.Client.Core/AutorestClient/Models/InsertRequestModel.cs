...
namespace Lykke.Service.OperationsRepository.AutorestClient.Models
{
    ...
    public partial class InsertRequestModel
    {
        ...
        /// 'Margin'</param>
        public InsertRequestModel(CashOutRequestTradeSystem tradeSystem, CashOutAttemptEntity request = default(CashOutAttemptEntity), PaymentSystemModel paymentSystem = default(PaymentSystemModel), object paymentFields = default(object))
        {
            Request = request;
