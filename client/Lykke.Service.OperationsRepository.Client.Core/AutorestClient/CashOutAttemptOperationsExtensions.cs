...
namespace Lykke.Service.OperationsRepository.AutorestClient
{
    ...
    public static partial class CashOutAttemptOperationsExtensions
    {
            ...
            /// <param name='to'>
            /// </param>
            public static object GetHistoryRecords(this ICashOutAttemptOperations operations, System.DateTime fromParameter, System.DateTime to)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> GetHistoryRecordsAsync(this ICashOutAttemptOperations operations, System.DateTime fromParameter, System.DateTime to, CancellationToken cancellationToken = default(CancellationToken))
            {
